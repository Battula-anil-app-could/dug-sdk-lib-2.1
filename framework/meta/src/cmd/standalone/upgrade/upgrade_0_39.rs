...
fn v_0_39_prepare_meta(sc_crate_path: &Path) {
    ...
    print_cargo_dep_remove(cargo_toml_path.as_path(), "dharitr-wasm");
    deps.remove("dharitr-wasm");

    print_cargo_dep_remove(cargo_toml_path.as_path(), "dharitr-wasm-debug");
    deps.remove("dharitr-wasm-debug");
...
fn v_0_39_prepare_wasm(sc_crate_path: &Path) {
    ...
    print_cargo_dep_remove(cargo_toml_path.as_path(), "dharitr-wasm-output");
    deps.remove("dharitr-wasm-output");
...
fn v_0_39_replace_in_files(sc_crate_path: &Path) {
    replace_in_files(
        ...
        "*Cargo.toml",
        &[
            Query::substring("dharitr-wasm-debug", "dharitri-sc-scenario"),
            Query::substring("dharitr-wasm-modules", "dharitri-sc-modules"),
            Query::substring("dharitr-wasm-node", "dharitri-sc-wasm-adapter"),
            Query::substring("dharitr-wasm", "dharitri-sc"),
        ][..],
    );
    ...
    replace_in_files(
        ...
        "*rs",
        &[
            Query::substring("dharitr_codec", "codec"),
            Query::substring(
                "dharitr_wasm_debug::meta::perform",
                "dharitri_sc_meta::cli_main",
            ),
            Query::substring(
                "dharitr_wasm_debug::mandos_go",
                "dharitri_sc_scenario::run_go",
            ),
            Query::substring(
                "dharitr_wasm_debug::mandos_rs",
                "dharitri_sc_scenario::run_rs",
            ),
            Query::substring("dharitr_wasm_debug", "dharitri_sc_scenario"),
            Query::substring("dharitr_wasm_modules", "dharitri_sc_modules"),
            Query::substring("dharitr_wasm_node", "dharitri_sc_wasm_adapter"),
            Query::substring("dharitr_wasm", "dharitri_sc"),
