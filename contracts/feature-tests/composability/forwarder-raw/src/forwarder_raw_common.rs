...
pub trait ForwarderRawCommon {
    ...
    fn callback_payments(&self) -> VecMapper<(EgldOrDctTokenIdentifier, u64, BigUint)>;

    #[view]
    fn callback_payments_triples(
        &self,
    ) -> MultiValueEncoded<MultiValue3<EgldOrDctTokenIdentifier, u64, BigUint>> {
    ...
    /// Used in the dharitr-go tests, do not remove.
    #[view]
    ...
    fn callback_payment_at_index(
        &self,
        index: usize,
    ) -> MultiValue3<EgldOrDctTokenIdentifier, u64, BigUint> {
